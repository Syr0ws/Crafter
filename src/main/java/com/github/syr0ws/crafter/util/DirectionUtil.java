...
/**
 * Utility class for determining directions based on {@link Location}.
 */
public class DirectionUtil {

    /**
     * Determines the cardinal direction from one location to another.
     *
     * @param current the current location.
     * @param to the target location.
     * @return the {@link Direction} from the current location to the target location.
     */
